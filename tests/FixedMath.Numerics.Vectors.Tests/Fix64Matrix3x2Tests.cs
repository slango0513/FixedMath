...
{
    public class Fix64Matrix3x2Tests
    {
        ...
        // A test for CreateRotation (Single)
        [Fact]
        ...
        // A test for CreateRotation (Single, Vector2f)
        [Fact]
        ...
        // A test for Lerp (Matrix3x2, Matrix3x2, Single)
        [Fact]
        ...
        // A test for Multiply (Matrix3x2, Single)
        [Fact]
        ...
        // A test for CreateScale (Single, Vector2f)
        [Fact]
        ...
        // A test for CreateScale (Single, Single)
        [Fact]
        ...
        // A test for CreateScale (Single, Single, Vector2f)
        [Fact]
        ...
        // A test for CreateTranslation (Single, Single)
        [Fact]
        ...
        // A test for CreateSkew (Single, Single)
        [Fact]
        ...
        // A test for CreateSkew (Single, Single, Vector2f)
        [Fact]
        ...
        {
            Matrix3x2 a = new Matrix3x2(Single.NaN, 0, 0, 0, 0, 0);
            Matrix3x2 b = new Matrix3x2(0, Single.NaN, 0, 0, 0, 0);
            Matrix3x2 c = new Matrix3x2(0, 0, Single.NaN, 0, 0, 0);
            Matrix3x2 d = new Matrix3x2(0, 0, 0, Single.NaN, 0, 0);
            Matrix3x2 e = new Matrix3x2(0, 0, 0, 0, Single.NaN, 0);
            Matrix3x2 f = new Matrix3x2(0, 0, 0, 0, 0, Single.NaN);
