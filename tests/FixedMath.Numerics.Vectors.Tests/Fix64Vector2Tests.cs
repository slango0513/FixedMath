...
{
    public class Fix64Vector2Tests
    {
        [Fact]
        ...
        // A test for Dot (Vector2f, Vector2f)
        // Dot test with specail Single values
        [Fact]
        ...
        // A test for Lerp (Vector2f, Vector2f, Single)
        [Fact]
        ...
        public void Vector2UnaryNegationTest1()
        {
            ...
            Assert.True(Single.IsNegativeInfinity(actual.X), "Vector2f.operator - did not return the expected value.");
            Assert.True(Single.IsPositiveInfinity(actual.Y), "Vector2f.operator - did not return the expected value.");
        }
        ...
        public void Vector2UnaryNegationTest2()
        {
            ...
            Assert.True(Single.IsNaN(actual.X), "Vector2f.operator - did not return the expected value.");
            Assert.True(Single.Equals((Single)0.0f, actual.Y), "Vector2f.operator - did not return the expected value.");
        }
        ...
        // A test for operator * (Vector2f, Single)
        [Fact]
        ...
        // A test for operator * (Single, Vector2f)
        [Fact]
        ...
        public void Vector2DivisionTest3()
        {
            ...
            Assert.True(Single.IsInfinity(actual.X), "Vector2f.operator / did not return the expected value.");
            Assert.True(Single.IsInfinity(actual.Y), "Vector2f.operator / did not return the expected value.");
        }
        ...
        // A test for Divide (Vector2f, Single)
        [Fact]
        ...
        public void Vector2DivideTest1()
        {
            ...
            Vector2 expected = new Vector2((Single)1.0f / 5.0f, (Single)6.0f / 2.0f);
            Vector2 actual;
        ...
        // A test for Multiply (Vector2f, Single)
        [Fact]
        ...
        // A test for Multiply (Single, Vector2f)
        [Fact]
